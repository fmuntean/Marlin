...
//
/* MFD: removed as I don't have heated chamber */
 ...
 */
  ...
  #define PID_EXTRUSION_SCALING  //MFD: enabled this
...
/* MFD: removed as I don't a BLTouch */
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING  //MFD: enabled this
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define GCODE_REPEAT_MARKERS    //MFD: enabled this        // Enable G-code M808 to set repeat markers and do looping
  ...
  #define MEDIA_MENU_AT_TOP    //MFD: enabled this            // Force the media menu to be listed on the top of the main menu
  ...
  #define LONG_FILENAME_HOST_SUPPORT   //MFD: enabled this // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES       //MFD: enabled this  // Scroll long filenames in the SD card menu
...
/* MFD: removed the rest of the displays I don't have */
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE    //MFD: enabled this    // Allow babystepping at all times (not just during movement)
  ...
  #define BABYSTEP_DISPLAY_TOTAL   //MFD: enabled this       // Display total babysteps since last G28
...
#define BEZIER_CURVE_SUPPORT  //MFD: enabled this        // Requires ~2666 bytes
...
#define FWRETRACT //MFD enabled this
 ...
 // #define FWRETRACT_AUTORETRACT   //MFD disabled this as the printer stops after first move         // costs ~500 bytes of PROGMEM
...
/* MFD: removed section as I don't have this */
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_FANS_PAUSE  //MFD: enabled this           // Turn off print-cooling fans while the machine is paused.
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES       //MFD: enabled this    // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
...
/* MFD: removed section as I don't have these drivers*/
...
#define REPETIER_GCODE_M360  //MFD: enabled this   // Add commands originally from Repetier FW
 ...
 */
//#define MAX7219_DEBUG  //MFD: disabled this 
...
/* MFD: Section removed: I don't have Prusa MMU */
