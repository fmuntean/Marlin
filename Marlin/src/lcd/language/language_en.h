...
#ifdef CNC
	LSTR MSG_CNC                = _UxGT("CNC");
	LSTR MSG_CNC_PROBE          = _UxGT("XYZ Probing");
	LSTR MSG_CNC_PROBE_X_RIGHT  = _UxGT("X Axis right");
	LSTR MSG_CNC_PROBE_X_LEFT   = _UxGT("X Axis left");
	LSTR MSG_CNC_PROBE_Y_RIGHT  = _UxGT("Y Axis right");
	LSTR MSG_CNC_PROBE_Y_LEFT   = _UxGT("Y Axis left");
	LSTR MSG_CNC_PROBE_Z        = _UxGT("Probing Z Axis down");
	LSTR MSG_CNC_MILLING        = _UxGT("Milling");
	LSTR MSG_CNC_MILL           = _UxGT("Mill");
	LSTR MSG_CNC_START          = _UxGT("Start");
	LSTR MSG_CNC_DRILL          = _UxGT("Drill");
	LSTR MSG_CNC_DRILLING       = _UxGT("Drilling");
	LSTR MSG_CNC_MILLING_TOOL   = _UxGT("Tool d:[mm]");
	LSTR MSG_CNC_MILLING_OVERLAP= _UxGT("Milling Overlap");
	LSTR MSG_CNC_MILLING_DEPTH  = _UxGT("Depth [mm]");

	LSTR MSG_CNC_MILLING_SPEED        = _UxGT("Speed [mm/m]");
	LSTR MSG_CNC_MILLING_X            = _UxGT("Board X size");
	LSTR MSG_CNC_MILLING_Y            = _UxGT("Board Y size");
	LSTR MSG_CNC_MILLING_TOP_SURFACE  = _UxGT("Mill Top surface");
	LSTR MSG_CNC_MILLING_X_SIDE       = _UxGT("Mill X side");
	LSTR MSG_CNC_MILLING_Y_SIDE       = _UxGT("Mill Y side");
	LSTR MSG_CNC_RESET_ALL            = _UxGT("Reset All Coordinates");

	LSTR MSG_CNC_RESET_X          = _UxGT("Reset X Axis");
	LSTR MSG_CNC_RESET_Y          = _UxGT("Reset Y Axis");
	LSTR MSG_CNC_RESET_Z          = _UxGT("Reset Z Axis");
	LSTR MSG_CNC_TOOL_WORKSPACE   = _UxGT("Set Tool Workspace");
	LSTR MSG_CNC_MOVE_TOOL_CHANGE = _UxGT("Move to Tool change Position");
	LSTR MSG_CNC_MOVE_WORKPIECE   = _UxGT("Move to Workpiece Origin");
	LSTR MSG_CNC_SCAN             = _UxGT("Scan gcode file");
	LSTR MSG_CNC_SCAN_BOX         = _UxGT("Move Around the Area");

	LSTR MSG_CNC_MOVE                 = _UxGT("Move");
	LSTR MSG_CNC_SET_WORKPIECE_ORIGIN = _UxGT("Set Workpiece Origin");
	LSTR MSG_CNC_SCANNING             = _UxGT("Scanning File...");
	LSTR MSG_CNC_DISABLE_Z            = _UxGT("Disable Z Motors");

	LSTR MSG_CNC_X          = _UxGT("X=");
	LSTR MSG_CNC_Y          = _UxGT("Y=");
	LSTR MSG_CNC_WORKPIECE  = _UxGT("WorkPiece");
}
